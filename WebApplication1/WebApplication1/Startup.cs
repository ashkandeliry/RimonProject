...
using EshopLoginManagment.ScheduledTask;
...
namespace WebApplication1
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IUserSignup_BLL, UserSignup_BLL>();
            services.AddScoped<IUserSignUp_DAL, UserSignUp_DAL>();

            services.AddScoped<IWreatherStatus_BLL, WreatherStatus_BLL>();
            services.AddScoped<IWreatherStatus_DAL, WreatherStatus_DAL>();
            ...
            //services.AddSingleton<IHostedService, weartherTask1>();
        }
